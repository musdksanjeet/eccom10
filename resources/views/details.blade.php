                        ...
                        <div class="col-md-6">
                            <div class="cloth-details-size">
                                ...
                                <div class="product-buttons">
                                    ...
                                    <a href="javascript:void(0)" onclick="event.preventDefault();document.
                                     getElementById('addtocart').submit();" id="cartEffect" class="btn btn-solid hover-solid btn-animation"> 
